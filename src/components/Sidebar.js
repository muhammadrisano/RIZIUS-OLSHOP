            ...
            item.addEventListener('mouseenter', function (evt) {
                ...
                if (datas !== undefined) {
                    let a = datas.map(item => {
                        ...
                        return (
                            <li style={{ padding: "4px 10px", fontSize: 13.5, color: "#666" }}>{item}<span style={{ position: "absolute", width: 20, right: 5, marginTop: -22, display: 'none' }}><img src={icon} width="100%" alt=""/></span></li>
                        )
                    })
